...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "节点池": "Node Pool",
  "抓取源": "Scraper Sources",
  "抓取源管理": "Scraper Source Management",
  "管理代理抓取源，用于 scrape 类型订阅自动获取代理列表。": "Manage proxy scraper sources for automatic proxy list fetching in scrape-type subscriptions.",
  "抓取源列表": "Scraper Source List",
  "共 {{count}} 个源": "{{count}} sources",
  "抓取源 {{name}} 创建成功": "Scraper source {{name}} created",
  "抓取源 {{name}} 已更新": "Scraper source {{name}} updated",
  "抓取源 {{name}} 已删除": "Scraper source {{name}} deleted",
  ...
  "已启用": "Enabled",
  "已禁用": "Disabled",
  "Plain Text (IP:PORT)": "Plain Text (IP:PORT)",
  "JSON (Geonode)": "JSON (Geonode)",
  "JSON (SocksList)": "JSON (SocksList)",
  "JSON (PubProxy)": "JSON (PubProxy)",
  "JSON (Proxifly)": "JSON (Proxifly)",
  "没有匹配的抓取源": "No matching scraper sources",
  "正在加载数据...": "Loading data...",
  "搜索源": "Search sources",
  "请求头规则": "Header Rules",
  "请求日志": "Request Logs",
